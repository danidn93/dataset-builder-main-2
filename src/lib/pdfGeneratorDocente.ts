...
export const generarReportePDFDocente = async (
  data: ReporteData,
  ...
  pdf.setFontSize(28);
  pdf.text("Reporte de Satisfacción Docente", pageWidth / 2, 100, {
    align: "center",
  });
  ...
  pdf.setFontSize(10);
  pdf.setTextColor(...COLORES.gris);
  pdf.text("Reporte de Satisfacción Docente", margin, y);
  y += 10;
  ...
  const introText = `En el marco del fortalecimiento de la calidad académica y de los servicios institucionales, la Dirección de Aseguramiento de la Calidad aplicó la Encuesta de Satisfacción Docente correspondiente al ${data.periodo} a la carrera de ${data.carrera} con el propósito de evaluar el nivel de satisfacción de los docentes y establecer acciones de mejora.`;
  ...
  const resultadosText = "A continuación, se presentan los resultados obtenidos en cada uno de los criterios evaluados en la encuesta de satisfacción docente. Estos reflejan la percepción de los docentes sobre diversos aspectos que inciden en su experiencia académica y formativa.";
  ...
  const recomendaciones = [
    ...
    "Realizar un seguimiento periódico de los indicadores de satisfacción docente para evaluar el impacto de las acciones implementadas.",
    ...
    "Implementar mecanismos de retroalimentación que permitan a los docentes participar activamente en los procesos de mejora institucional."
  ];
